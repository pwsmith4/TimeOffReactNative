...
<View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, width:width }}>
  <View style={{ alignItems: 'flex-start' }}>
    <Text style={{fontSize: 25 }}>Start Date</Text>
    <Text style={{fontSize: 25 }}>{startDate.toLocaleDateString('en-US')}</Text>
      </View>
  <View style={{ alignItems: 'flex-end' }}>
    <Text style={{fontSize: 25 }}>End Date</Text>
    <Text style={{fontSize: 25 }}>{endDate.toLocaleDateString('en-US')}</Text>
  </View>
</View>
<View>
